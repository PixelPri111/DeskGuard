...
export default function StudentView({ desks }) {
  ...
  const [myStudentId, setMyStudentId] = useState(
    localStorage.getItem('myStudentId') || null
  );
  const [myStudentName, setMyStudentName] = useState(
    localStorage.getItem('myStudentName') || null
  );
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2">
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm">
              Click a green desk to check in or book a future slot.
            </p>
          </div>
          ...
          <DeskMap desks={desks} onBooking={openBookingModal} />
          ...
          {showBooking && bookingDesk && (
            <BookingModal
              deskNumber={bookingDesk}
        ...
        <div className="col-span-1">
          <MyBookings studentId={myStudentId} />
        </div>
      </div>
    </div>
  );
